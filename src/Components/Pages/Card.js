...
const Card = () => {
  // let [arr1] = localStorage.getItem("MyDataq");

  // console.log("LKLKLKLKLKKK", arr1[0]?.content);
  const [edit, setEdit] = useState([]);
  // const serverUrl =
  //   process.env.NODE_ENV === "production"
  //     ? process.env.REACT_APP_PRODUCTION_SERVER_URL
  //     : process.env.REACT_APP_DEVELOPMENT_SERVER_URL;
  // console.log(serverUrl + "fserver");
  ...
  useEffect(() => {
    ...
    console.log(edit, "1111444444");
  }, []);

  return (
    <div>
      <h1></h1>
      <p>fdfjdsfjdjddfdfdfd</p>
      <p>fdfjdsfjdjddfdfdfd</p>
      <p>fdfjdsfjdjddfdfdfd</p>
    </div>
  );
